    ...
    */
	...
	function init()	{
		if (!ns4)
		{
			...
			if (showToday==1)
			{
				document.getElementById("lblToday").innerHTML =	todayString + " " + dateNow + " " + monthName[monthNow] + " " + (yearNow+543);
			}
	...
	function constructMonth() {
		...
		if (!monthConstructed) {
			...
			document.getElementById("selectMonth").innerHTML = "<table width='70' style='font-family:arial; font-size:11px; border-width:1; border-style:solid; border-color:#a0a0a0; background-color: #FFFFDD' bgcolor='#FFFFDD' cellspacing=0 onmouseover='clearTimeout(timeoutID1)'	onmouseout='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"popDownMonth()\",100);event.cancelBubble=true'>" +	sHTML +	"</table>"
		...
		if (!yearConstructed) {
			...
			for	(i=(yearSelected-3); i<=(yearSelected+3); i++) {
				...
				if (i==yearSelected){
					...
					sHTML += "<tr><td id='y" + j + "' onmouseover='this.style.backgroundColor=\"#FFCC99\"' onmouseout='this.style.backgroundColor=\"\"' style='cursor:pointer' onclick='selectYear("+j+");event.cancelBubble=true'>&nbsp;" + (sName+543) + "&nbsp;</td></tr>"
					j ++;				
				}
			}
			...
			document.getElementById("selectYear").innerHTML	= "<table width='44' style='font-family:arial; font-size:11px; border-width:1; border-style:solid; border-color:#a0a0a0; background-color: #FFFFDD'	bgcolor='#FFFFDD' onmouseover='clearTimeout(timeoutID2)' onmouseout='clearTimeout(timeoutID2);timeoutID2=setTimeout(\"popDownYear()\",100)' cellspacing=0>"	+ sHTML	+ "</table>"
   ...
   function WeekNbr(n) {
      ...
      J = day + Math.floor((153 * mm + 2) / 5) + 365 * y + b - 32045;
