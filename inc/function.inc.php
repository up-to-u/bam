...
function ad_authen($login, $password, &$info) {	$info = array(		'name' => 'Ratchapong', 		'surname' => 'Santimataneedol', 		'name_en' => 'Ratchapong', 		'surname_en' => 'Santimataneedol', 		'tel' => $telephonenumber, 		'email' => $email, 		'code' => '60236', 		'pid' => $pid, 		'department_name' =>$department, 		'level' =>$level, 		'position' =>$position	);			return true;	}/*
