...
<?		} ?>
		...
		<div class="col-lg-2"> <label>ตำแหน่งที่นั่ง </label><input type="text" class="form-control"  placeholder="กรุณาระบุชั้น/ฝั่ง (กรณีสำนักงานใหญ่) "  name='floor' value='<?=$row2['floor']?>'></div>
			...
			<div class="col-lg-2"><label>LINE ID </label><input type="text" class="form-control" placeholder="LINE ID" name='line_user_id' value='<?=$row2[line_user_id]?>'></div>
