									...
									<tbody>
										...
										?>
											<tr>
												...
												<td style="vertical-align: middle;"><div class="col-lg-12"><?= $row['incidence']; ?></div></td>
												...
												<td>
													...
													<button name='submit' class="btn btn-primary editDetailData" style="width: 110px;" 
														...
														<form action="loss_data_list.php?statusListId=<?= $statusListId ?>&action=approve" method="post" target="_blank" style="display: inline;">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-lg-12 col-xs-12">
								...
								<div class="form-group">
									<div class="row">
										<div class="col-lg-6 col-xs-12"><label class="margins-top-10 label-main">วันที่เกิดเหตุการณ์</label><input type="text" class="form-control datepicker" name='edit_happen_date' readonly id='edit_happen_date'></div>
										<div class="col-lg-6 col-xs-12"><label class="margins-top-10 label-main">วันที่ตรวจพบ<span style="color: red;">*</span></label><input type="text" class="form-control datepicker" name='edit_checked_date' readonly id='edit_checked_date'></div>
										<div class="col-lg-12 col-xs-12"><label class="margins-top-10 label-main">เหตุการณ์<span style="color: red;">*</span></label><input type="text" class="form-control" name='edit_incidence' id='edit_incidence'></div>
										...
										<div class="col-lg-12 col-xs-12"><label class="margins-top-10 label-main">ผลกระทบ<span style="color: red;">*</span></label><input type="text" class="form-control" name='edit_user_effect' id='edit_user_effect'></div>
										...
										<div class="col-lg-3"> <label class="margins-top-10 col-xs-12 label-main" style="margin-left: -13px;">Loss :<span style="color: red;">*</span> </label><label class="radio-inline"><input type="radio" name="edit_loss_type" id="edit_loss_type1" value="1"> Actual Loss
											</label></div>
										...
										<div class="col-lg-12"><label class="margins-top-10 label-main">การควบคุมที่มีอยู่<span style="color: red;">*</span></label><input type="text" class="form-control" name='edit_control' id='edit_control'></div>
										<div class="col-lg-3"><label class="margins-top-10 label-main">มูลค่าความเสียหาย (บาท)<span style="color: red;">*</span></label><input type="text" class="form-control" name='edit_loss_value' id='edit_loss_value'></div>
										<div class="col-lg-3"><label class="margins-top-10 label-main">โอกาส<span style="color: red;">*</span></label><select name='edit_chance' id='edit_chance' class="form-control">
												<option value="0">- - - เลือก - - - </option>
												<?
												$iFactor4 = 4;
												$makdel4 = 0;
										...
										<div class="col-lg-3"><label class="margins-top-10 label-main">ผลกระทบ<span style="color: red;">*</span></label><select name='edit_effect' id='edit_effect' class="form-control">
												<option value="0">- - - เลือก - - - </option>
												<?
												$iFactor3 = 3;
												$makdel3 = 0;
										...
										<div class="col-lg-4"><label class="margins-top-10 label-main">ฝ่ายงานที่เกี่ยวข้อง 1</label><select name='edit_dep_id_1' id='edit_dep_id_1' class="form-control">
										...
										<div class="col-lg-4"><label class="margins-top-10 label-main">ฝ่ายงานที่เกี่ยวข้อง 2</label><select name='edit_dep_id_2' id='edit_dep_id_2' class="form-control">
												<option value="0"> - - - -</option>
												<?
										...
										<div class="col-lg-4"><label class="margins-top-10 label-main">ฝ่ายงานที่เกี่ยวข้อง 3</label><select name='edit_dep_id_3' id='edit_dep_id_3' class="form-control">
												<option value="0"> - - - -</option>
												<?
												$sql = "SELECT * FROM department 
													WHERE 
										...
										<div class="col-lg-12"><label class="margins-top-10 label-main"><br> <a href="#" id="edit_attech_name_download" style="text-decoration: none;"><span class="glyphicon glyphicon-download-alt" style="margin-left: 20px;"></span> >> ดาวน์โหลดเอกสาร << </label></a></label>
	...
	$(".editDetailData").on("click", function() {
		...
		xmlhttp.onload = function() {
			const myObj = JSON.parse(this.responseText);
				...
				for (let x in myObj) {
					reFact = myObj[x].factor_no;
				

				if(edit_damage_types == myObj[x].loss_factor_id ){
					Checked = "selected";
				}else{
					Checked = "";
				}
			
					$("#edit_damage_type").append('<option value="' +  myObj[x].loss_factor_id  + '@' +  myObj[x].factor_no +'"  ' + Checked +'>' + myObj[x].factor +'</option>');
				}
		...
		// alert(reFact);
		// $arrayDamageEdit = 1;
		// alert($arrayDamageEdit );
		// const dbParamEdit = JSON.stringify({
		// 	"limit": arrayDamageEdit
		// });
		// const xmlhttp = new XMLHttpRequest();
		// xmlhttp.onload = function() {
		// 	const myObj = JSON.parse(this.responseText);
		...
		// 		for (let x in myObj) {
		// 			iCount++;
		// 			$("#edit_incidence_type").append('<option value="' + iCount + '">' + myObj[x].factor + '</option>');
		// 		}


		// }
		// xmlhttp.open("POST", "api/lossDataOnchangeEditIncidence.php");
		// xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		// xmlhttp.send("x=" + dbParamEdit);
