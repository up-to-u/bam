...
?>
			<tr id='add_row' style='display:none'>
				<td>
					เพิ่ม<br>
					<input type='text' class="form-control" name='add_q_no'>
				</td>
				<td><br>
					<input type='text' class="form-control" name='add_q_name'></td>
				<td></td>
				<td><button type="submit" name='submit' value='add_topic' class="btn btn-success"><i class='fa fa-save'></i> บันทึก</button></td>
			</tr>
			</tbody>
			</table>
			</form>
